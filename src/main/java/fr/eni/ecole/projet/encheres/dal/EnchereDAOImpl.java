...
public class EnchereDAOImpl implements EnchereDAO {
	...
	private static final String TROUVER_DERNIERE_ENCHERE = "SELECT id_utilisateur,no_article, montant_enchere, date_enchere FROM encheres WHERE no_article=:idArticle ORDER BY date_enchere DESC";
